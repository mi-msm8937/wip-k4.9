...
static const struct snd_kcontrol_new land_stub_rx_mixer_controls[] = {
	SOC_DOUBLE_EXT("Voice Stub", SND_SOC_NOPM,
...
#ifdef CONFIG_MACH_XIAOMI_LAND
static const struct snd_kcontrol_new land_slimbus_1_rx_mixer_controls[] = {
	SOC_DOUBLE_EXT("Voice Stub", SND_SOC_NOPM,
...
#ifdef CONFIG_MACH_XIAOMI_LAND
static const struct snd_kcontrol_new land_slimbus_3_rx_mixer_controls[] = {
	SOC_DOUBLE_EXT("Voice Stub", SND_SOC_NOPM,
...
#ifdef CONFIG_MACH_XIAOMI_LAND
static const struct snd_soc_dapm_widget land_msm_qdsp6_widgets[] = {
	SND_SOC_DAPM_MIXER("STUB_RX Mixer", SND_SOC_NOPM, 0, 0,
	land_stub_rx_mixer_controls, ARRAY_SIZE(land_stub_rx_mixer_controls)),
	SND_SOC_DAPM_MIXER("SLIMBUS_1_RX Mixer", SND_SOC_NOPM, 0, 0,
	land_slimbus_1_rx_mixer_controls, ARRAY_SIZE(land_slimbus_1_rx_mixer_controls)),
	SND_SOC_DAPM_MIXER("SLIMBUS_3_RX_Voice Mixer", SND_SOC_NOPM, 0, 0,
	land_slimbus_3_rx_mixer_controls, ARRAY_SIZE(land_slimbus_3_rx_mixer_controls)),
};
...
#ifdef CONFIG_MACH_XIAOMI_LAND
static const struct snd_soc_dapm_route land_intercon[] = {
...
static int msm_routing_probe(struct snd_soc_platform *platform)
{
	...
	if (xiaomi_device_read() == XIAOMI_DEVICE_LAND)
		snd_soc_dapm_new_controls(&platform->component.dapm, land_msm_qdsp6_widgets,
				ARRAY_SIZE(land_msm_qdsp6_widgets));
	else
...
#ifdef CONFIG_MACH_XIAOMI_LAND
	if (xiaomi_device_read() == XIAOMI_DEVICE_LAND)
		snd_soc_dapm_add_routes(&platform->component.dapm, land_intercon,
			ARRAY_SIZE(land_intercon));
	else
