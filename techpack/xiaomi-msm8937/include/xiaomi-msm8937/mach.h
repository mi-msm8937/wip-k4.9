...
extern int xiaomi_msm8937_get_mach_family(void);
extern int xiaomi_msm8937_get_mach(void);
#if IS_ENABLED(CONFIG_MACH_FAMILY_XIAOMI_WINGTECH)
extern char *xiaomi_msm8937_mach_get_wingtech_board_id(void);
#endif
#else
static inline int xiaomi_msm8937_get_mach_family(void) { return XIAOMI_MSM8937_MACH_FAMILY_UNKNOWN; }
static inline int xiaomi_msm8937_get_mach(void) { return XIAOMI_MSM8937_MACH_UNKNOWN; }
#if IS_ENABLED(CONFIG_MACH_FAMILY_XIAOMI_WINGTECH)
